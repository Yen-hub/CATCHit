...
import { Shield, Menu, Settings, LayoutDashboard, Search, AlertTriangle, ShieldAlert, History } from 'lucide-react';
...
const DashboardLayout = () => {
  ...
  const menuItems = [
    ...
    { icon: ShieldAlert, label: 'Scan', path: '/scan' },
    ...
    <div className="flex h-screen overflow-hidden bg-cyber-black">
      ...
      >
        ...
        <div className="p-4 flex items-center">
          <Shield className={cn("h-8 w-8 text-cyber-purple animate-pulse-glow", collapsed ? "mx-auto" : "mr-3")} />
          {!collapsed && (
            <div className="flex flex-col">
              <span className="text-xl font-bold tracking-wider cyber-text-glow">
                CATCH<span className="text-cyber-orange">it</span>
              </span>
              <span className="text-[10px] text-gray-400 -mt-1">CYBER GUARDIAN</span>
            </div>
          )}
        </div>
              ...
              <li key={item.label}>
                <NavLink
                  ...
                  className={({ isActive }) => cn(
                    ...
                    isActive ? "bg-cyber-purple/20 text-cyber-purple-light" : "text-gray-400 hover:bg-cyber-purple/10 hover:text-cyber-purple-light",
