...
import { Shield, Save, Bell, Clock, Lock, Monitor, Cpu, RefreshCw } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="col-span-1">
          <CyberCard className="mb-6">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-gray-400 mb-2">Scan Schedule</label>
                <select 
                  value={schedule} 
              ...
              <div className="flex items-center justify-between">
                ...
                <div 
                  className={`relative w-12 h-6 transition-colors duration-300 rounded-full ${deepScan ? 'bg-cyber-purple' : 'bg-cyber-dark'} cursor-pointer`}
                  onClick={() => setDeepScan(!deepScan)}
                >
                  <div 
                    className={`absolute top-1 left-1 w-4 h-4 transition-transform duration-300 rounded-full bg-white ${deepScan ? 'transform translate-x-6' : ''}`}
                  />
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div 
                  className={`relative w-12 h-6 transition-colors duration-300 rounded-full ${startupScan ? 'bg-cyber-purple' : 'bg-cyber-dark'} cursor-pointer`}
                  onClick={() => setStartupScan(!startupScan)}
                >
                  <div 
                    className={`absolute top-1 left-1 w-4 h-4 transition-transform duration-300 rounded-full bg-white ${startupScan ? 'transform translate-x-6' : ''}`}
                  />
                </div>
              </div>
          ...
          <CyberCard>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div 
                  className={`relative w-12 h-6 transition-colors duration-300 rounded-full ${notifications ? 'bg-cyber-purple' : 'bg-cyber-dark'} cursor-pointer`}
                  onClick={() => setNotifications(!notifications)}
                >
                  <div 
                    className={`absolute top-1 left-1 w-4 h-4 transition-transform duration-300 rounded-full bg-white ${notifications ? 'transform translate-x-6' : ''}`}
                  />
                </div>
              </div>
              
              <div>
                <label className="block text-gray-400 mb-2">Notification Level</label>
        ...
        <div className="col-span-1">
          <CyberCard className="mb-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div 
                  className={`relative w-12 h-6 transition-colors duration-300 rounded-full ${autoUpdate ? 'bg-cyber-purple' : 'bg-cyber-dark'} cursor-pointer`}
                  onClick={() => setAutoUpdate(!autoUpdate)}
                >
                  <div 
                    className={`absolute top-1 left-1 w-4 h-4 transition-transform duration-300 rounded-full bg-white ${autoUpdate ? 'transform translate-x-6' : ''}`}
                  />
                </div>
              </div>
              
              <div>
                <label className="block text-gray-400 mb-2">Threat Database</label>
                <div className="flex items-center">
                  <span className="text-gray-400 mr-2">Last updated: 2025-04-05</span>
                  <CyberButton size="sm">
              ...
              <div>
                <label className="block text-gray-400 mb-2">Storage Management</label>
          ...
          <CyberCard>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-gray-400 mb-2">Keep History For</label>
                <select className="cyber-input w-full bg-cyber-dark/50">
          ...
          <CyberCard>
            ...
            <div className="space-y-4">
              <div className="bg-cyber-dark/30 p-4 rounded-md">
                ...
                <p className="text-center text-xs text-gray-400 mb-2">CYBER GUARDIAN SHIELD</p>
                <p className="text-center text-sm text-gray-400">Version 1.0.0</p>
                <p className="text-center text-sm text-gray-400">Build 2025.04.05.1</p>
              </div>
              
              <div className="text-center">
                <p className="text-sm text-gray-500 mb-2">© 2025 CATCHit Security</p>
                <div className="flex justify-center space-x-3">
                  <a href="#" className="text-cyber-purple-light text-sm hover:underline">Privacy Policy</a>
                  <a href="#" className="text-cyber-purple-light text-sm hover:underline">License</a>
                  <a href="#" className="text-cyber-purple-light text-sm hover:underline">Support</a>
                </div>
              </div>
            </div>
          </CyberCard>
