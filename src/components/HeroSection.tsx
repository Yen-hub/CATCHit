  ...
  const handleScan = () => {
    ...
    setTimeout(() => {
      ...
      if (inputValue.includes("malware") || inputValue.includes("virus")) {
        ...
        inputValue.includes("suspicious") ||
        inputValue.includes("warning")
      ) {
        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-6">
              Real-time threat detection for safer browsing, downloads, and
              online interactions.
            </p>
            <p className="text-gray-400 mb-8">
              Don't be a target. CATCHit scans, predicts, and shields you from
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <RouterLink to="/dashboard/scan">
                <CyberButton>Launch Scanner</CyberButton>
              </RouterLink>
            </div>
          ...
          <div className="flex-1 w-full max-w-md">
            <div className="cyber-panel p-6 relative overflow-hidden">
              <div className="mb-6">
                <h2 className="text-2xl font-bold mb-2 cyber-text-glow">
                  Threat Scanner
                </h2>
                <p className="text-sm text-gray-400">
                  Enter a URL or upload a file to scan for threats
                </p>
              </div>
